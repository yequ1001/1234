...
class Meting
{
    ...
    {
        $this->header['CookieExtend'] = $value;
    ...
    private function curlset()
    {
        switch ($this->server) {
            ...
            return array(
                ...
                'CookieExtend' => 'os=pc; osver=Microsoft-Windows-10-Professional-build-10586-64bit; appver=2.0.3.131777; channel=netease; __remember_me=true',
            ...
            return array(
                ...
                'CookieExtend' => 'pgv_pvi=22038528; pgv_si=s3156287488; pgv_pvid=5535248600; yplayer_open=1; ts_last=y.qq.com/portal/player.html; ts_uid=4847550686; yq_index=0; qqmusic_fromtag=66; player_exist=1',
                'User-Agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36',
            );
            case 'xiami':
            return array(
                'Referer'    => 'http://h5api.m.xiami.com/',
                'CookieExtend' => '_m_h5_tk=15d3402511a022796d88b249f83fb968_1511163656929; _m_h5_tk_enc=b6b3e64d81dae577fc314b5c5692df3c',
            ...
            return array(
                ...
                'CookieExtend' => 'kg_mid='.$this->getRandomHex(32),
                'User-Agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36',
            );
            case 'baidu':
            return array(
                'CookieExtend' => 'BAIDUID='.$this->getRandomHex(32).':FG=1',
    ...
    private function xiami_sign($api)
    {
        ...
        $this->header['CookieExtend'] = $match[0][0].'; '.$match[0][1];
        ...
        $appkey = '12574478';
        $cookie = $this->header['CookieExtend'];
